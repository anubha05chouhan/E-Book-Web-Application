<%-- 
    Document   : all_books
    Created on : 15 Jul, 2024, 2:27:11 PM
    Author     : Abc1
--%>
      ...
      %>
           <tr>
            ...
            <td>
              ...
              <a href="${pageContext.request.contextPath}/delete_books?id=<%=b.getBookId()%>" class="btn btn-sm btn-danger" ><i class="fa-solid fa-trash"></i> Delete</a>
            </td>
          </tr>
      <%
      }  
